...
/*Diferencas para a primeira entrega: Nao tinha visto a ordem em que deveria ser armazenadas as constantes
 * do polinimio na 2.5. Em vez de {12, 2, 3}, estava armazendo {3, 2, 12}. O problema foi corrigido*/